...
# ---------------------------------------------------------------------------
FREELANCER_DB = [
    {"id": 1, "name": "Priya Sharma", "title": "Senior UI/UX Designer", "skills": ["Figma", "React", "Design Systems"], "rate": 65, "rating": 4.9, "verified": ["React", "Figma"], "availability": "Available", "completeness": 92},
    {"id": 2, "name": "Marcus Chen", "title": "Full-Stack Developer", "skills": ["Python", "Flask", "PostgreSQL"], "rate": 85, "rating": 4.8, "verified": ["Python"], "availability": "Busy", "completeness": 88},
    {"id": 3, "name": "Elena Vasquez", "title": "Brand & Motion Designer", "skills": ["After Effects", "Illustrator", "Branding"], "rate": 55, "rating": 4.95, "verified": [], "availability": "Available", "completeness": 76},
    {"id": 4, "name": "Jordan Blake", "title": "Video Editor & Producer", "skills": ["Premiere Pro", "DaVinci", "YouTube"], "rate": 45, "rating": 4.7, "verified": ["Video"], "availability": "Available", "completeness": 84},
    {"id": 5, "name": "Aisha Okonkwo", "title": "Technical Content Writer", "skills": ["SEO", "API Docs", "Blogging"], "rate": 50, "rating": 4.85, "verified": ["Writing"], "availability": "Limited", "completeness": 90},
    {"id": 6, "name": "Sam Rivera", "title": "Frontend Developer", "skills": ["JavaScript", "CSS", "Vue"], "rate": 70, "rating": 4.6, "verified": [], "availability": "Available", "completeness": 70},
]
